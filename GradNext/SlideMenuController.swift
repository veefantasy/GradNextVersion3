...
extension UIViewController {
    ...
    public func addLeftBarButton(_ buttonImage: UIImage) {
...
//        navigationItem.rightBarButtonItem = rightButton
    ...
    public func addRightBarButtonWithTwoImage(_ buttonImage: UIImage,_HomeImage : UIImage)
    {
        ...
        let rightButton1: UIBarButtonItem = UIBarButtonItem(image: _HomeImage, style: UIBarButtonItemStyle.plain, target: self, action: #selector(self.goHome))
        navigationItem.rightBarButtonItems = [rightButton,rightButton1]
